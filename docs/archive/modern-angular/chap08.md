...
После начала работы с Standalone Components возникает вопрос, как перенести существующее решение Angular в будущее без модулей Angular. В этой главе я покажу четыре варианта, как это сделать.
