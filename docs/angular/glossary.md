...
## Элемент Angular {#angular-element}
...
## Формат пакета Angular (APF) {##angular-package-format-apf}
...
## Директива атрибута {#attribute-directive}
...
## Декоратор поля класса {#class-field-decorator}
...
## Проекция контента {#content-projection}
...
## Декоратор {#decorator--decoration}
...
## Внедрение зависимостей (DI) {#dependency-injection-di}
...
Angular предоставляет ряд встроенных директив, которые начинаются с префикса `ng`. Вы также можете создавать новые директивы для реализации собственной функциональности. Вы связываете _селектор_ с пользовательской директивой; это расширяет [синтаксис шаблона][aioguidetemplatesyntax], который вы можете использовать в своих приложениях.
...
## Элемент управления формой {#form-control}
...
## Хуки жизненного цикла {#lifecycle-hook}
...
## Аутлет маршрутизатора {#router-outlet}
...
## Структурная директива {#structural-directive}
...
## Формы, управляемые шаблонами {#template-driven-forms}
...
## Входная переменная шаблона {#template-input-variable}
...
## Конфигурационный файл TypeScript {#typescript-configuration-file}
...
## Конфигурация рабочего пространства {#workspace-configuration}
...
[aioguidebrowsersupport]: https://angular.io/guide/browser-support 'Browser support | Angular'
...
[aioguidestyleguide0201]: https://angular.io/guide/styleguide#02-01 'Style 02-01 - Angular coding style guide | Angular'
