...
Компонент _компонента_ управляет участком экрана, называемым [*вид*] (руководство/глоссарий#вид "Определение вида"). Он состоит из класса TypeScript, шаблона HTML и таблицы стилей CSS. Класс TypeScript определяет взаимодействие
