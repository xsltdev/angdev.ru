...
Вызовите `configureTestingModule`, чтобы уточнить конфигурацию модуля тестирования для определенного набора тестов, добавляя и удаляя импорт, декларации (компонентов, директив и труб) и провайдеров.
