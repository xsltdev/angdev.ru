...
For example, in the basic application generated by the [Angular CLI](https://angular.io/cli), `BrowserModule` is the first import at the top of the `AppModule`, `app.module.ts`.

<code-example format="typescript" language="typescript">

/_ import modules so that AppModule can access them _/
...
For more information on the difference, see [JavaScript Modules vs. NgModules](ngmodule-vs-jsmodule.md).
